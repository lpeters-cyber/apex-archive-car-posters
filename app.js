...
starterPosters.push(...(window.koenigseggCatalog||[]),...(window.porscheCatalog||[]),...(window.f1Catalog||[]),...(window.racetrackCatalog||[]),...(window.bikeCatalog||[]));
const savedPosters=localStorage.getItem("apex-posters");
const savedList=savedPosters===null?null:JSON.parse(savedPosters), seedVersion="16";
